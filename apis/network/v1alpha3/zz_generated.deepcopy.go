...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrivateEndpointProperties) DeepCopyInto(out *PrivateEndpointProperties) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrivateEndpointProperties.
func (in *PrivateEndpointProperties) DeepCopy() *PrivateEndpointProperties {
	if in == nil {
		return nil
	}
	out := new(PrivateEndpointProperties)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PrivateEndpointSpec) DeepCopyInto(out *PrivateEndpointSpec) {
	*out = *in
	...
	in.PrivateEndpointProperties.DeepCopyInto(&out.PrivateEndpointProperties)
	if in.Tags != nil {
...
func (in *PrivateLinkServiceConnection) DeepCopyInto(out *PrivateLinkServiceConnection) {
	*out = *in
	if in.SubresourceID != nil {
		in, out := &in.SubresourceID, &out.SubresourceID
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
